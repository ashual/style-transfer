...
def classify_transferred():
    # evaluate the transfer
    with open('logs/test_results_transferred.txt', 'r') as f:
        transferred_strings = f.read().splitlines()
    analyzed_sentiments, analyzed_security = classify(transferred_strings)
