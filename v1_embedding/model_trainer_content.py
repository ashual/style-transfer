...
# class ModelTrainerContent(ModelTrainerBase):
...
#                                                   self.config['model']['discriminator_hidden_states'],
...
#     with open("config/gan_content.yml", 'r') as ymlfile:
#         config = yaml.load(ymlfile)
#     with open("config/operational.yml", 'r') as ymlfile:
#         operational_config = yaml.load(ymlfile)
#
#     ModelTrainerContent(config, operational_config).do_train_loop()
