...
# from v1_embedding.model_trainer_validation_cross_entropy import ModelTrainerValidation
...
#
# ModelTrainer = ModelTrainerValidation(config, operational_config)
# data = ModelTrainer.embedding_handler
