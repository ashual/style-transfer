...
class InputPipeline():
    def __init__(self, pretrained_glove_file, text_file, force_vocab=False,
                 start_of_sentence_token=None, unknown_token=None):
    ...
    def batch_iterator(self, shuffle=True, maximal_batch=100):
        ...
        for sentence in sentences:
            indexed_sentence = [find_in_vocab(w, self.word_to_index) for w in word_tokenize(sentence)]
...
input_stream = InputPipeline(pretrained_glove_file=r"C:\temp\data\style\glove.6B\glove.6B.50d.txt",
                             text_file=r"C:\Users\user\Dropbox\projects\StyleTransfer\yoda\english_yoda.text",
