...
class Scramble(Dataset):
    def __init__(self, is_scramble, limit_sentences, validation_limit_sentences, dataset_cache_dir, dataset_name):
        Dataset.__init__(self, limit_sentences=limit_sentences, validation_limit_sentences=validation_limit_sentences,
                         dataset_cache_dir=dataset_cache_dir, dataset_name=dataset_name)
